/****************************************************************************
** Meta object code from reading C++ file 'MessageListModel.hpp'
**
...
#include <memory>
#include "../include/DataHandlingPackages/models/MessageListModel.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MessageListModel.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(17, 22), // "considerNewTextMessage"
QT_MOC_LITERAL(40, 0), // ""
QT_MOC_LITERAL(41, 8) // "msg_info"

    },
    "MessageListModel\0considerNewTextMessage\0"
    "\0msg_info"
};
...
void MessageListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->considerNewTextMessage((*reinterpret_cast< const QJsonObject(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
, QtPrivate::TypeAndForceComplete<MessageListModel, std::true_type>
